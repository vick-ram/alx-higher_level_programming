#!/usr/bin/python3
"""4-rectangle module that adds repr() functionality"""


class Rectangle:
    """a Rectangle class that adds rpr() to return
    ...
    def __str__(self):
        """returns inormally formatted string"""
        if self.__width == 0 or self.__height == 0:
            return ""
        return "\n".join("#" * self.__width for _ in range(self.__height))

    def __repr__(self):
        """returns string reperesenation of an object"""
